...
> **Nota:** Este documento é a evidência consolidada da replicabilidade do V8.
> A branch operacional `experiment/vet-vertical` contém os 4 arquivos editados
> (branding.js, schema.js, mock.js, etl-normalize.js) com as mudanças aplicadas.
> Essa branch NÃO é merged em main — é experimento isolado para validação.
