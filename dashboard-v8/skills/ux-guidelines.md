...
>
> **Nota V8**: O conteúdo deste arquivo é independente de arquitetura — aplica-se igualmente a V7 e V8.
> As referências a "HTML único" ou "Borg.*" são do V7; em V8, substitua mentalmente por "projeto Vite + ES modules" e "import from domain/ui/view".
