// View: Upload (Importar Dados) - port from V7 Upload view
// Architecture mirrors overview.js / works.js patterns

import { showToast } from './shared.js';
import { VIEW_LABELS } from '../model/branding.js';

// Mounts the Upload view into the provided host element. Returns an unmount function.
...
`;
  ...
  function render() {
    ...
    uploadInfoEl = host.querySelector('#upload-info');
